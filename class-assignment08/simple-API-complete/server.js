...
app.post("/api/vehicles", passport.authenticate('jwt', { session: false }), (req, res) => {
    dataService.addVehicle(req.body).then((vehicle) => {
...
app.delete("/api/vehicles/:id", passport.authenticate('jwt', { session: false }), (req, res) => {
    const vehicleId = parseInt(req.params.id);
    dataService.deleteVehicle(vehicleId).then((vehicle) => {
        if (vehicle) {
            res.json(vehicle);
        } else {
